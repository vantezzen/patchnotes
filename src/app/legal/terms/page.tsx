...
function Terms() {
  return (
    <LegalPage>
      <Head>
        <title>SparkTunes - Terms of Service</title>
      ...
      <div className="mx-auto max-w-lg">
        ...
        <p>
          ...
          SparkTunes for TikTok ("Service"), a web application that provides
          personalized statistics on your TikTok usage. The Service is provided
          by SparkTunes for TikTok LLC ("we", "us" or "our").
        </p>
        <p>
